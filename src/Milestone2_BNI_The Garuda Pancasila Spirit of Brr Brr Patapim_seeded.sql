...
('bagus17@example.org','Y&3eTVO#KlB@','Yulia Haryanto','1964-09-03',60),
('baktiadizulaika@example.org','NHv^Yw62+%K8','Yono Wijayanti','1964-11-15',60),
('baktionopalastri@example.net','MPg_Wkws2F2S','Ir. Jarwi Haryanto, S.Gz','1965-01-03',60),
('balapatimahendra@example.net','!2QSYGws(Ik3','Uchita Santoso','2001-06-01',23),
('budiyantoraharja@example.org','TY&hyCCi0l2E','Safina Kuswandari','1992-08-10',32),
('cager91@example.org','^!ONYmt#Y5SU','Ajeng Padmasari','1995-07-23',29),
('capanurdiyanti@example.net','wK7_vZl$**AE','Hana Puspasari','1967-07-22',57),
('cawisonozulaika@example.net','@^B7YrL2x!Yo','Hj. Widya Yuniar, S.Ked','1955-03-09',70),
('cemplunk36@example.com','8aDc(fdG#A4T','Abyasa Andriani, S.Gz','2006-08-15',18),
('cemplunkadriansyah@example.org','xC+COAMs&#3w','Tantri Ardianto','1975-12-27',49),
('chutapea@example.org','w(2!posiDG4d','Tgk. Hafshah Dongoran, S.Gz','1987-04-02',38),
('crajata@example.org','^6Cn^&UGuUK$','Dr. Endra Mahendra, S.I.Kom','1985-03-16',40),
('dalima15@example.net','g8Q70fnr)wK5','Ir. Jinawi Haryanti','1956-04-24',69),
('digdaya32@example.net','7sfHU1)p_x5Q','Dr. Hana Laksita, S.IP','1978-12-31',46),
('dimazpradipta@example.net','pq+P2)Lz4+F0','Wardaya Puspasari','1973-09-18',51),
('dsaragih@example.com','h&2t5LePefB$','Maras Sihotang','1979-12-19',45),
('dsinaga@example.org','Z_LWs6ci2!X#','R.A. Ika Gunarto, S.Sos','1993-07-28',31),
('elma89@example.net','q+98wx7w&QXC','Cut Sari Susanti, S.H.','1973-05-01',52),
('emangunsong@example.com','dpI9p(su_eBD','Ir. Zulaikha Siregar, M.Farm','1984-04-28',41),
('emaniswahyudi@example.com','$iHx6QEJ&35%','Paulin Prabowo','1974-06-01',50),
('endra26@example.com','@3jGPsg@q^kn','Rachel Rahayu','1970-02-16',55),
('fitriani02@example.net','C)E%W!6uI8Ru','Sutan Kardi Dabukke','1992-05-01',33),
('fsiregar@example.org','O6y6Iux(M_I3','R. Padmi Yulianti','1986-07-19',38),
('fujiatititi@example.org','RP4TPOsi*w)5','Melinda Latupono','1958-03-06',67),
('gamanto56@example.com','lr+Nwe&2*96J','Pardi Irawan, S.Pd','2006-07-14',18),
('ganda49@example.org','blJnSA61Nj3$','Ir. Damar Palastri','1992-01-21',33),
('ganda51@example.net','wK_N%x&4Q@9K','KH. Pangeran Wasita, M.Ak','1956-07-18',68),
('ganjaranhasanah@example.com','hbRLIcqc^9t4','Hj. Gawati Wibisono, S.T.','1974-04-04',51),
('garamarbun@example.com','0YX8aEj7#p6C','Drs. Fathonah Uyainah, S.IP','1997-01-14',28),
('gunawanrama@example.com','Se77C*iRu&9+','dr. Gandi Lailasari','1995-02-21',30),
('hadiyolanda@example.com','^4tWO_zzRQ5X','Cawuk Siregar','1987-10-31',37),
('hafshahpermata@example.org','@S!fvGqyB6SO','Kani Kuswandari','1997-08-11',27),
('halimahandayani@example.org','%ZwTa)*J@B7i','Patricia Kusumo','1971-08-01',53),
('handayanioskar@example.org','YrxPOf*O%0XL','Tina Megantara, M.TI.','2006-06-20',18),
('harsanto38@example.net','n80)ZNuo%qyG','Nalar Sudiati, S.T.','1994-07-08',30),
('harsanto52@example.com','3*1AisoF*%Ei','Asirwanda Salahudin, S.Kom','1982-10-02',42),
('harsayapangestu@example.net','BS#fP3oZtR@7','Prasetyo Hutasoit','1958-03-08',67),
('hartakanugroho@example.org','(kekohdh40Vz','KH. Cawisono Wibowo','2003-10-23',21),
('hasanbudiman@example.org','#@)0EDipmQMA','Pangeran Mustofa','1969-03-30',56),
('hassanahasmadi@example.com','5dlm7FTlC!Y_','Ida Wahyudin','1964-01-18',61),
('hestiutami@example.org','5Oms_0Uz)6&M','Elvina Ardianto','1989-12-31',35),
('hmayasari@example.net','7*Xfkam+&TY0','Nadia Nababan','1960-04-22',65),
('humairagunarto@example.net','#N05BLsc+D6A','Tasdik Widodo, S.I.Kom','1995-08-04',29),
('ida60@example.net','jI9ZHzon%v%t','Bajragin Utami','1967-09-19',57),
('irfanpuspita@example.org','(5jb%LaqV92$','Dian Pranowo','1975-07-30',49),
('jabal43@example.com',')EOpGEsN6Fio','Dr. Prayitna Prasasta, S.IP','1961-11-16',63),
('jagaraga55@example.com','+V1RoOKraae(','Nasim Irawan','1964-07-23',60),
('jailanicinthia@example.org','+zIk5)3yN22s','Hilda Gunawan','1998-06-30',26),
('jmustofa@example.org','+ZEU9Vq617N#','Yessi Mangunsong','1998-10-20',26),
('jnasyidah@example.net','ut07aDKxJ#18','drg. Panca Gunawan, M.M.','1963-01-14',62),
('jonogunawan@example.net','iV_8DfR4d)_S','Gandi Adriansyah','2006-05-11',19),
('jwijaya@example.net','d)oXRjxrs0#@','Puti Farah Mayasari','1974-11-01',50),
('kamila99@example.net','_9*8Lqw6_eJ2','Dadap Nugroho','2001-01-18',24),
('kamilasudiati@example.net','+x8w6g#SzfAU','Darman Hutagalung','1963-11-21',61),
('karen51@example.org','%^TWTjlJGs8A','Puti Tantri Prabowo','1995-05-02',30),
('karjahalim@example.net','k_jUfKhKnU6O','Asmianto Gunarto','1974-06-14',50),
('kasiran02@example.com','#0LKb5ak*nZC','Ratih Wibowo','1990-08-28',34),
('kayunputra@example.net','F)aCVeuYG1I7','Mulya Farida','1989-06-21',35),
('keisha01@example.net','*%1CUcrWu9+Q','Zulfa Simanjuntak','1979-11-24',45),
('kgunarto@example.net','HXd3(9Re4&&S','Tgk. Ifa Oktaviani, S.E.','1991-03-03',34),
('kiandra54@example.org','#H(IH3my+&7O','Hendra Sihombing','1987-01-13',38),
('knasyidah@example.org','F$#7n#gzb#6C','Tgk. Raisa Marbun','1981-02-20',44),
('kpurwanti@example.org','$73XCwgjRBY+','Drs. Gatot Usamah','1990-08-18',34),
('kusumokezia@example.org','1_FIUBiUdu95','Rahayu Waluyo','2003-12-01',21),
('langgengnashiruddin@example.net',')v0EMipK!Inu','R. Mahmud Kuswandari','1990-10-30',34),
('lantarwaluyo@example.org','!7TfcG4e+$q+','Vanya Widiastuti','1956-06-28',68),
('latifpadmasari@example.org','gZ0Y8fMqp!du','drg. Dadap Laksita, M.M.','1979-07-28',45),
('lega72@example.org','eiLPG8Gn@x^5','Sari Pradana','1968-04-19',57),
('lidyapangestu@example.com','x$9jGNzr#DO^','Ifa Widiastuti','1994-04-08',31),
('limar53@example.net','D$v&3%KufFai','Asmadi Hassanah','1966-08-27',58),
('limar98@example.org','(3eB#ogq&lBU','Sutan Wahyu Purwanti','1969-10-17',55),
('lukitamayasari@example.net','+c+G*Jlc*Oz0','Eman Prastuti','1971-12-23',53),
('lyulianti@example.org','#M5UYAf_Q2d#','Zamira Budiman','2006-08-06',18),
('maheswarabaktianto@example.net','+4c&x(C8r2Sj','dr. Wulan Halimah','1968-11-01',56),
('maida92@example.com','#@BwUi7yqs7A','Jati Saefullah','1995-11-21',29),
('malikanababan@example.net','P%Z1CdEf#8#s','Puti Jelita Suryono','1973-06-19',51),
('manullangira@example.org','t+a0Lz)T6sRR','dr. Ikhsan Wulandari','1977-02-20',48),
('maras14@example.net',')MMGKosVt*2R','Tari Yulianti','1957-06-26',67),
('maulanapatricia@example.com','xG9y2VrvIm!2','R. Febi Irawan, M.Ak','1964-03-27',61),
('mrahimah@example.com','QjIwrtxA&0SB','Nugraha Anggraini, S.Sos','1975-03-03',50),
('mumpuniutama@example.org','5l@qgVdy)!&0','Ajiman Usamah','1991-10-05',33),
('mursita01@example.net','j%x2T_BqPB2Y','Radika Prabowo','1993-11-27',31),
('muyainah@example.com','#JwVTp^yH2@N','Abyasa Manullang','1959-12-25',65),
('najamdabukke@example.org','S0FCGQVp$+yh','Dr. Putri Kuswandari, S.H.','1984-02-13',41),
('najib59@example.com','2)0Zt+e0zqGG','Gatra Hakim','1960-07-30',64),
('nasab15@example.net','FF57TzXh@2mU','Ilsa Pratama','1998-10-16',26),
('natsirhilda@example.com','Nw(kPxaa#2Aw','Dr. Daruna Sitompul, S.T.','1974-10-08',50),
('natsirjono@example.net','1hN4VSiF%m67','Bakti Saptono, M.Pd','1968-04-28',57),
('niyagapradipta@example.net','X9mmLgRk&6%^','Michelle Lazuardi','1983-08-31',41),
('nnasyiah@example.com','%sCUPjJt&b0+','Cut Olivia Dabukke','1994-01-02',31),
('nwidiastuti@example.net','%O90CiFI9bLF','Hana Puspita, S.Pt','1964-08-19',60),
('oktavianiedi@example.com','&s2%TuInTIeJ','Ghani Mangunsong','1979-03-22',46),
('omahendra@example.com','+2XiwP3CR1dD','Ajimin Yulianti, S.Kom','1992-02-12',33),
('opudjiastuti@example.com','m%LQWhlNAR0X','Hj. Nova Nugroho','1984-02-11',41),
('osudiati@example.net','_7JHoawlj32z','Ega Uwais','1979-12-03',45),
('padmatamba@example.net','WT7*RJiP__0M','Tgk. Kala Lestari, S.Psi','1991-03-14',34),
('palastrigara@example.com','!MD7MIGcn5rB','dr. Ulya Zulkarnain','1963-12-22',61),
('permatafitriani@example.com','#&*UEdDJ)6dP','Zalindra Budiyanto','1990-05-28',34),
('pradanayessi@example.net','xL(stTorDe7p','Prabowo Utami','1984-05-30',40),
('prakasapurwa@example.com','g579Hi2v#FuH','Mala Tamba','1987-04-21',38),
('pramadan@example.com','_O09m_3LbwuS','Niyaga Prasasta','1961-03-19',64),
('prasetyabella@example.net','ii_Xh5yu!3Z7','R. Kurnia Gunawan','1960-02-15',65),
('prasetyarajasa@example.com','itd#+VBk_3OA','Ir. Vicky Maheswara','1962-11-09',62),
('prayitna27@example.org','khO#A+4nF#80','Ir. Omar Dongoran','1959-04-21',66),
('puji38@example.net','*lNWkMyNp7UE','Tgk. Puput Dabukke','1987-09-26',37),
('putraibrani@example.com','I3BbApsd@y5l','R.M. Karman Hastuti, M.Pd','1995-10-30',29),
('rahayu87@example.org','#vzpMCmejnc5','Samiah Nasyiah, S.I.Kom','1964-09-23',60),
('rahmanlaksita@example.net','03kga1Bq(Q^@','Mila Waluyo, M.TI.','1981-04-13',44),
('raisa80@example.org','_2hw(AhN5(1V','Ir. Tania Palastri, M.Ak','1967-05-04',58),
('safitrigalak@example.com','*yNGOPeXG5e#','Victoria Wacana','1969-05-02',56),
('samosirrosman@example.com','CV4NGQfa*BHx','R.M. Latif Lailasari','1966-06-16',58),
('saptonojayeng@example.com','u+T%jo0i82yN','Tgk. Estiono Wasita','1991-04-29',34),
('sarah91@example.org','vx9aQvRag*(T','Darsirah Hariyah','1982-06-27',42),
('sbudiman@example.org','xOJgWAqc&3rp','Puti Nova Oktaviani, S.Sos','2002-01-14',23),
('sihombinglantar@example.com','1(Nw7Wpc&R5(','Dirja Prakasa','1999-02-03',26),
('sihombingqueen@example.org','O!H!f3YmfQC(','Chandra Damanik','1962-05-29',63),
('sihombingutama@example.org','t)Z0&2oq#1mz','Zamira Maulana','1960-06-06',64),
('silviariyanti@example.org','5_$5Aep5_3IY','Puti Talia Wastuti, S.Pd','1964-08-22',60),
('suciyulianti@example.org','d5kFERtz(%VH','Opung Narpati','1998-05-24',26),
('tania31@example.net','()a9p_UiK_#8','Ophelia Dongoran','1990-05-23',35),
('taniasimbolon@example.org','@AL7lajoY7hi','Makara Nababan','1999-10-27',25),
('twaluyo@example.org','2s72AkUu@n^b','Maimunah Melani','1958-10-22',66),
('uaryani@example.com','%7Pwi)8@$Tai','Lutfan Tampubolon','1986-06-19',38),
('usuryono@example.net','&7NFYFtg01oH','Edi Najmudin','2003-12-02',21),
('utamahardiansyah@example.net','(i86dDEs%+AB','Pia Hutasoit','1955-12-12',69),
('uuwais@example.org','762UBsar@4fK','Putri Ardianto','1992-11-22',32),
('vanesa24@example.com','jMhU5D4$Z0Q$','Artawan Wibowo','1983-05-21',42),
('vanesapermata@example.net','B9eKGavb#SNz','Ami Samosir, S.Psi','2006-11-05',18),
('vanyafujiati@example.org','J#cAPQr((+P4','Syahrini Mandasari','1990-12-16',34),
('vinopuspita@example.com','3LhuZ03r@vDw','Imam Nababan','1971-02-22',54),
('wahyusaragih@example.net','&6XBm3jGl9Yb','Suci Saragih','1966-09-27',58),
('wakiman29@example.org','z3zvxiG)+4xK','R. Marwata Saptono','1998-10-10',26),
('waluyoeja@example.org','JMAFje9C_z3z','Bagiya Suryono','1995-03-02',30),
('waluyoganjaran@example.com','!soRQ$mxJ76U','Warji Maulana, M.TI.','1960-09-24',64),
('waluyoilyas@example.com','N^bP$I1r@0sC','Qori Wijaya','1961-11-13',63),
('warjijailani@example.org','kU7Pot#Hn$jX','Novi Wasita','1977-10-24',47),
('wartaprasetya@example.org','I$noRyc0!KUM','Ir. Mitra Nurdiyanti, S.T.','1954-11-14',70),
('wastutikemal@example.net','yA0%4P5f)t9e','Ir. Puji Fujiati','1971-09-29',53),
('wgunarto@example.com','6IRFV7l1cn3^','Mahesa Prasasta','1991-06-27',33),
('widiastutinadine@example.org',')1X$KNDksfUB','Laras Hartati','1967-04-22',58),
('winarnowage@example.org','@lMtXiUv13Yv','Ozy Rahmawati, S.I.Kom','2003-10-13',21),
('winda56@example.com','w2x1w)sH)WWC','Kenari Setiawan, S.Psi','1955-07-26',69),
('xananauwais@example.org','Vgg!Rt+I@%L1','Dalima Saputra, M.TI.','1963-08-22',61),
('ynainggolan@example.net','*bkI7TacJFqy','Siska Sitorus','1964-09-03',60),
('yolandakani@example.net','!b3UQgeh9!EW','Nadia Sirait','1995-05-21',30),
('zalindra02@example.com','WPjdlI&I@9Zx','Keisha Farida','1973-03-11',52);
...
INSERT INTO `tenaga_medis` (`email`, `nama_departemen`, `id_rumah_sakit`, `NIKes`, `jenis_profesi`) VALUES ('adiarja64@example.org','Anak',879,'7705608782022','Bidan'),
('akarsanairawan@example.org','Kulit',766,'1781995750772','Bidan'),
('asirwanda75@example.com','Kulit',60,'2158204792806','Perawat'),
('asmuni43@example.net','Umum',698,'5401169512024','Bidan'),
('baktiadizulaika@example.org','Umum',698,'0675344740006','Dokter Umum'),
('balapatimahendra@example.net','Umum',247,'0804117496554','Bidan'),
('cawisonozulaika@example.net','Gigi',247,'6050854185884','Dokter Umum'),
('cemplunk36@example.com','Kulit',574,'4740325361641','Dokter Spesialis'),
('cemplunkadriansyah@example.org','Kardiologi',60,'3554909742570','Dokter Umum'),
('chutapea@example.org','Kulit',306,'0470468978218','Bidan'),
('crajata@example.org','Kulit',766,'7869740626931','Dokter Umum'),
('dalima15@example.net','Neurologi',698,'2555631500460','Perawat'),
('elma89@example.net','Neurologi',698,'2043953803531','Perawat'),
('emangunsong@example.com','Kardiologi',60,'9691335785406','Bidan'),
('emaniswahyudi@example.com','Anak',949,'3334088134874','Dokter Umum'),
('endra26@example.com','Bedah',432,'1891190831364','Bidan'),
('fsiregar@example.org','Gigi',766,'1217818617330','Dokter Spesialis'),
('fujiatititi@example.org','Anak',949,'6743816645488','Dokter Spesialis'),
('gamanto56@example.com','Anak',879,'1586622022440','Dokter Spesialis'),
('ganda51@example.net','Neurologi',198,'2311364923415','Perawat'),
('garamarbun@example.com','Kardiologi',428,'9287775976742','Perawat'),
('hafshahpermata@example.org','Umum',757,'2616903648898','Bidan'),
('halimahandayani@example.org','Kardiologi',574,'8954942475070','Dokter Umum'),
('handayanioskar@example.org','Anak',791,'4839728188730','Dokter Umum'),
('harsanto38@example.net','Kardiologi',532,'8086542246788','Perawat'),
('harsanto52@example.com','Kardiologi',532,'1921336123234','Bidan'),
('harsayapangestu@example.net','Kulit',306,'6035757919002','Bidan'),
('hartakanugroho@example.org','Gigi',879,'2664259037712','Bidan'),
('hasanbudiman@example.org','Anak',766,'2675675460206','Dokter Umum'),
('hassanahasmadi@example.com','Kulit',574,'7097080058420','Bidan'),
('hestiutami@example.org','Gigi',879,'6756891279813','Dokter Umum'),
('humairagunarto@example.net','Anak',879,'5344919500110','Dokter Spesialis'),
('ida60@example.net','Gigi',766,'1950156722334','Bidan'),
('irfanpuspita@example.org','Gigi',766,'0418712793187','Perawat'),
('jabal43@example.com','Neurologi',306,'2380624787074','Dokter Umum'),
('jnasyidah@example.net','Gigi',514,'7707009692962','Dokter Umum'),
('jonogunawan@example.net','Kulit',267,'1892120701399','Perawat'),
('jwijaya@example.net','Neurologi',60,'6069483250955','Bidan'),
('kamila99@example.net','Kardiologi',757,'0446008092591','Perawat'),
('kamilasudiati@example.net','Gigi',345,'1246932226845','Dokter Umum'),
('karen51@example.org','Anak',60,'7816274127472','Bidan'),
('karjahalim@example.net','Kulit',887,'6868974552888','Perawat'),
('kasiran02@example.com','Kulit',574,'5185350206731','Bidan'),
('kayunputra@example.net','Kardiologi',345,'8288361054708','Perawat'),
('keisha01@example.net','Kardiologi',791,'5607275067643','Dokter Umum'),
('kgunarto@example.net','Neurologi',306,'8386148256779','Dokter Umum'),
('kiandra54@example.org','Gigi',879,'0233903014960','Bidan'),
('knasyidah@example.org','Kulit',306,'6106136359228','Perawat'),
('kusumokezia@example.org','Neurologi',306,'3450458181436','Dokter Spesialis'),
('langgengnashiruddin@example.net','Kardiologi',757,'6658280216372','Dokter Spesialis'),
('latifpadmasari@example.org','Kulit',718,'9351301421546','Bidan'),
('lega72@example.org','Gigi',879,'8740973000936','Dokter Umum'),
('lidyapangestu@example.com','Neurologi',198,'4276627158325','Dokter Spesialis'),
('lukitamayasari@example.net','Anak',576,'9255360992750','Perawat'),
('lyulianti@example.org','Kulit',514,'1732512365085','Dokter Umum'),
('malikanababan@example.net','Kardiologi',757,'4919645893839','Dokter Spesialis'),
('manullangira@example.org','Anak',267,'4337686118429','Dokter Spesialis'),
('maras14@example.net','Bedah',432,'7804294266998','Dokter Spesialis'),
('maulanapatricia@example.com','Gigi',514,'5399936194910','Dokter Umum'),
('mrahimah@example.com','Neurologi',532,'1482206393961','Dokter Umum'),
('mumpuniutama@example.org','Kardiologi',345,'1116956897997','Dokter Umum'),
('mursita01@example.net','Anak',267,'5930965857263','Bidan'),
('muyainah@example.com','Anak',791,'8795142015198','Dokter Spesialis'),
('najamdabukke@example.org','Kardiologi',428,'3033587009576','Perawat'),
('najib59@example.com','Kardiologi',428,'8469635985557','Bidan'),
('nasab15@example.net','Anak',879,'0942042243888','Bidan'),
('natsirhilda@example.com','Anak',267,'8978881199668','Perawat'),
('niyagapradipta@example.net','Anak',60,'7021367346429','Dokter Umum'),
('oktavianiedi@example.com','Anak',766,'6854548384399','Dokter Spesialis'),
('padmatamba@example.net','Neurologi',698,'3231362088611','Bidan'),
('palastrigara@example.com','Kulit',514,'6467713229250','Perawat'),
('permatafitriani@example.com','Kardiologi',887,'5795813019374','Dokter Spesialis'),
('pramadan@example.com','Kardiologi',345,'3418755359460','Dokter Umum'),
('prasetyarajasa@example.com','Anak',879,'6476282281729','Dokter Umum'),
('prayitna27@example.org','Kulit',532,'6195802846384','Dokter Spesialis'),
('puji38@example.net','Neurologi',198,'4917310989924','Dokter Spesialis'),
('putraibrani@example.com','Bedah',432,'2889249887652','Bidan'),
('raisa80@example.org','Kulit',267,'0847125316049','Perawat'),
('safitrigalak@example.com','Gigi',432,'1850779093746','Perawat'),
('saptonojayeng@example.com','Kulit',574,'3176634210225','Dokter Umum'),
('sbudiman@example.org','Neurologi',698,'6421291578803','Dokter Spesialis'),
('sihombinglantar@example.com','Neurologi',718,'9350438417798','Perawat'),
('sihombingutama@example.org','Umum',698,'9173799408188','Dokter Umum'),
('suciyulianti@example.org','Gigi',766,'8455206096029','Bidan'),
('taniasimbolon@example.org','Anak',879,'6760843605438','Bidan'),
('twaluyo@example.org','Kulit',574,'1677907901236','Bidan'),
('usuryono@example.net','Neurologi',198,'1843757441677','Dokter Umum'),
('utamahardiansyah@example.net','Anak',345,'8296772561814','Dokter Spesialis'),
('uuwais@example.org','Gigi',576,'1013773091907','Perawat'),
('vanesa24@example.com','Bedah',432,'7509986804563','Bidan'),
('wahyusaragih@example.net','Umum',247,'0027854913423','Perawat'),
('wakiman29@example.org','Kulit',514,'5422865734213','Perawat'),
('waluyoeja@example.org','Kardiologi',532,'4062767046178','Bidan'),
('waluyoganjaran@example.com','Kulit',60,'6184514054125','Bidan'),
('waluyoilyas@example.com','Neurologi',306,'8438871832024','Dokter Umum'),
('warjijailani@example.org','Kulit',887,'6092270913146','Dokter Umum'),
('widiastutinadine@example.org','Gigi',766,'7785220705425','Dokter Umum'),
('winarnowage@example.org','Neurologi',60,'5288651836482','Dokter Umum'),
('winda56@example.com','Umum',532,'3025929780793','Dokter Umum'),
('zalindra02@example.com','Anak',791,'7507595894494','Bidan');
